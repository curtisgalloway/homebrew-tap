...
class Paniolo < Formula
  ...
  bottle do
    root_url "https://github.com/curtisgalloway/paniolo/releases/download/v0.4.1"
    sha256 cellar: :any_skip_relocation, all:          "23f6507409a61d68d4c76b3713395d1884231347da43b4a1589c553c307e641d"
    sha256 cellar: :any_skip_relocation, arm64_linux:  "6e6ed691b6c7728ccc491c8e9422e0873ebcc049b493cea5b7f2cae3af2ca67e"
    sha256 cellar: :any_skip_relocation, x86_64_linux: "caeda70219f96f6320ee2a0b0a9c8e1870f56c1a590e59d68ab5040b998c854a"
  end
  ...
  on_macos do
    on_arm do
      url "https://github.com/curtisgalloway/paniolo/releases/download/v0.4.1/paniolo-0.4.1-macos-universal.tar.gz"
      sha256 "f5a0ab2deff418b26bf74edbef763b8de9891becc23e7cf2a3c92527c3bc639c"
    end
    on_intel do
      url "https://github.com/curtisgalloway/paniolo/releases/download/v0.4.1/paniolo-0.4.1-macos-universal.tar.gz"
      sha256 "f5a0ab2deff418b26bf74edbef763b8de9891becc23e7cf2a3c92527c3bc639c"
  ...
  on_linux do
    on_arm do
      url "https://github.com/curtisgalloway/paniolo/releases/download/v0.4.1/paniolo-0.4.1-linux-arm64.tar.gz"
      sha256 "f74634b0805ad7daffbd08f6dff117e24e3a4a696e13f50bca52c4e8e5330228"
    end
    on_intel do
      url "https://github.com/curtisgalloway/paniolo/releases/download/v0.4.1/paniolo-0.4.1-linux-amd64.tar.gz"
      sha256 "578d6e449ff5d8e69657adf7f98830cc459b5d8f0417a24ae54afb390975a448"
    end
  end
