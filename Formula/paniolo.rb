...
class Paniolo < Formula
  ...
  bottle do
    root_url "https://github.com/curtisgalloway/paniolo/releases/download/v0.5.1"
    sha256 cellar: :any_skip_relocation, all:          "0f56738434915fc2bab207c9a92d9ac27716e9778aa58b3fa6ce1f18aa36961e"
    sha256 cellar: :any_skip_relocation, arm64_linux:  "2b2b9dfeee8f341acb701d0ad1c4217281625de5aae179d3a4571ddf533548c1"
    sha256 cellar: :any_skip_relocation, x86_64_linux: "72de07a94ddc631457038302d0c419639112d8d7b33514353ed123082296d59b"
  end
  ...
  on_macos do
    on_arm do
      url "https://github.com/curtisgalloway/paniolo/releases/download/v0.5.1/paniolo-0.5.1-macos-universal.tar.gz"
      sha256 "0513a05dab76897c5568aae13cedacefce1502f4b3ef009971dffe06b64b5bfd"
    end
    on_intel do
      url "https://github.com/curtisgalloway/paniolo/releases/download/v0.5.1/paniolo-0.5.1-macos-universal.tar.gz"
      sha256 "0513a05dab76897c5568aae13cedacefce1502f4b3ef009971dffe06b64b5bfd"
  ...
  on_linux do
    on_arm do
      url "https://github.com/curtisgalloway/paniolo/releases/download/v0.5.1/paniolo-0.5.1-linux-arm64.tar.gz"
      sha256 "25ba7794bae4dd39371004edcd16bcd811233bc83394a8432fb768365a193a50"
    end
    on_intel do
      url "https://github.com/curtisgalloway/paniolo/releases/download/v0.5.1/paniolo-0.5.1-linux-amd64.tar.gz"
      sha256 "7a0bd948d9339b7dbb63e805f8c0136f356638d3487c74ca63111251fd06a40a"
    end
  end
